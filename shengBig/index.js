...
module.exports = Event.extend(function Base(container, config) {
  ...
  render: function (data, config) {
    ...
    //如果有需要的话,更新样式
    let that = this;
    var html = `<div id="shengBigSwiper" style="height:100%;"><div class="swiper-container"><div class="swiper-wrapper">`
    ...
    new Swiper('#shengBigSwiper .swiper-container', {
      slidesPerView: 4,
      spaceBetween: 10,
      ...
      on:{
        slideChangeTransitionStart: function(){
          var eventId = $("#shengBigSwiper .swiper-slide-active").attr("eventId");
          for(var i = 0;i<data.length;i++){
